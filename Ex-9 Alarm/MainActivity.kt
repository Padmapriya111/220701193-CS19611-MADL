...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btSetAlarm.setOnClickListener {
            ...
            pendingIntent = PendingIntent.getBroadcast(this.applicationContext,2, intent,PendingIntent.FLAG_CANCEL_CURRENT)
            val time:Long = calendar.timeInMillis - (calendar.timeInMillis % 60000)
            alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, time, 10000, pendingIntent)
        }
        btStopAlarm.setOnClickListener { alarmManager.cancel(pendingIntent)
